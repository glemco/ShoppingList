...
renderDays(week_days) {
  return week_days.map((day, index) => {
      return (
          ...
          <Text
            onPress={()=>this._showModal(day, index)}
            style={style.calendar_weekdays_text}>{day}</Text>
            </View>:
          <Text
          onPress={()=>this._showModal(day, index)}
          key={index} style={style.calendar_weekdays_text}>{day}</Text>
