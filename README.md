# ShoppingList
This README is not maintained right now, but all the methods inside the sources are well commented, so refer on them for documentation

*here the default README template from create-react-native-app starts*
